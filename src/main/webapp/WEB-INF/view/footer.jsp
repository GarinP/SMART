<footer class="footer">
    <div class="container">
        <div class="copyright">
            ...
            , made with <i class="fa fa-heart heart"></i> by Salvatore Kidung
        </div>
    </div>
</footer>
</div>
...
<!--  DatetimePicker   -->
<script src="${pageContext.request.contextPath}/assets/js/plugins/bootstrap-datetimepicker.js"></script>
<!--  Sweet Alert  -->
<script src="${pageContext.request.contextPath}/assets/js/plugins/sweetalert2.min.js" type="text/javascript"></script>
<!--  Tags Input  -->
<script src="${pageContext.request.contextPath}/assets/js/plugins/bootstrap-tagsinput.js" type="text/javascript"></script>
<!--  Sliders  -->
<script src="${pageContext.request.contextPath}/assets/js/plugins/nouislider.js" type="text/javascript"></script>
<!--  Bootstrap Select  -->
...
<script src="${pageContext.request.contextPath}/assets/js/plugins/bootstrap-table.js"></script>
<!--  DataTable Plugin -->
...
<script src="${pageContext.request.contextPath}/assets/js/delete.js"></script>
</html>
